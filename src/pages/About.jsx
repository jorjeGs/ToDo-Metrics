    ...
    return (
        <>
            ...
            <div className='h-screen'>
                <div id='first' className="relative bg-inherit h-1/2">
                    ...
                    <div className='flex flex-col-reverse md:flex-row justify-center sm:gap-0 gap-3 p-2'>
                        <div className='flex flex-col md:w-1/2 justify-center text-center h-auto mt-3 gap-2'>
                            <h1 className='text-6xl text-black dark:text-neutral-100 font-bold'>Hi!</h1>
                            <h2 className='sm:text-2xl text-lg text-balance text-center text-black dark:text-neutral-300'>This app was developed as a portfolio project for my web developer resume.</h2>
                        </div>
                    ...
                    <div className="custom-shape-divider-bottom-1703831514 pointer-events-none">
                        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                            <path d="M600,112.77C268.63,112.77,0,65.52,0,7.23V120H1200V7.23C1200,65.52,931.37,112.77,600,112.77Z" className="fill-gray-200 dark:fill-neutral-600"></path>
                        </svg>
                    </div>
                </div>
                <div className="relative bg-gray-200 dark:bg-neutral-600 h-auto min-h-1/2 p-3">
                    <div className='flex flex-col justify-center items-center gap-6'>
                        <div className='flex flex-col justify-center items-center text-center mt-4 md:gap-6 gap-4'>
                            ...
                            <h1 className='text-4xl text-black dark:text-neutral-100 font-bold'>Taskflow</h1>
                            <h2 className='sm:text-xl text-md text-balance text-black dark:text-neutral-300'><strong className='text-blue-600 dark:text-neutral-100'>Taskflow</strong> was made thinking as a Trello-based app with <strong>no registered account need</strong>.</h2>
                            <h2 className='sm:text-xl text-md text-balance text-black dark:text-neutral-100'>Organize your daily tasks with your progress <strong>locally storage</strong> in your browser.</h2>
                        </div>
                ...
                <div className="relative bg-[#004B87] dark:bg-neutral-500 h-auto">
