...
const TaskCard = (props) => {
    ...
    return (
        <>
            <div className="task flex flex-col mx-auto justify-center items-center overflow-hidden w-full sm:w-11/12 bg-white shadow-xl border-2 border-gray-200 rounded-md p-1 transition duration-200 transform hover:scale-110">
